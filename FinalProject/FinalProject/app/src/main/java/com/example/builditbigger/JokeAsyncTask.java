...
public class JokeAsyncTask extends AsyncTask<Pair<Context, String>, Void , String> {
    ...
    public JokeAsyncTask(Context ctx,View progressBar) {
        this.context=ctx;
    ...
    @Override
    protected String doInBackground(Pair<Context, String>... contexts) {
       ...
       // context = contexts[1];
        ...
        try {
            ...
            //return e.getMessage();
            //return put null because I don't server error message
            return  null;
        }
    }
